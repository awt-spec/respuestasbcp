...
export const questions: QuestionItem[] = [
  ...
  // ── Datos y Reporting (I) ──
  {
    ...
    respuesta: "𝗠𝗼𝘁𝗼𝗿 𝗱𝗲 𝗥𝗲𝗽𝗼𝗿𝘁𝗲𝘀 𝘆 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗼𝗿: SYSDE PLUS cuenta con un motor de reportería y un extractor de datos integrado que genera reportes regulatorios, contables y gerenciales de forma automática. El extractor permite construir consultas ad-hoc sobre cualquier dato operativo, contable o regulatorio sin intervención de desarrollo.\n\n𝗥𝗲𝗽𝗼𝗿𝘁𝗲𝘀 𝗥𝗲𝗴𝘂𝗹𝗮𝘁𝗼𝗿𝗶𝗼𝘀:\n• Generación automática para superintendencias (SBS Perú, SUGEF, SIB, CNBS, SSF, CNBV)\n• Formatos parametrizables por regulador (XML, CSV, Excel, PDF)\n• Clasificación de cartera y provisiones conforme a normativa local (incluyendo SBS Perú)\n• Concentración de riesgo y exposición crediticia\n• Reporte de operaciones sospechosas (ROS) y prevención de lavado\n• Generación de Anexos regulatorios específicos por jurisdicción\n\n𝗥𝗲𝗽𝗼𝗿𝘁𝗲𝘀 𝗖𝗼𝗻𝘁𝗮𝗯𝗹𝗲𝘀:\n• Asientos automáticos conforme a NIIF/IFRS 16 con libro mayor auxiliar\n• Balance de comprobación, P&L y flujo de caja por producto/segmento\n• Conciliación automática entre datos operativos y contables\n• Depreciación, amortización y reconocimiento de ingresos por método configurado\n• Estados financieros consolidados multi-entidad\n\n𝗥𝗲𝗽𝗼𝗿𝘁𝗲𝘀 𝗚𝗲𝗿𝗲𝗻𝗰𝗶𝗮𝗹𝗲𝘀:\n• Dashboards operativos con KPIs (cartera activa, mora, originación, rentabilidad)\n• Generador de reportes ad-hoc parametrizable por el usuario\n• Análisis de cosecha, vintage y comportamiento de cartera\n• Exportación en Excel, PDF, CSV con distribución automática por correo\n\n𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗼𝗿 𝗱𝗲 𝗗𝗮𝘁𝗼𝘀:\n• Herramienta visual para construir consultas sin código\n• Acceso a todas las capas de datos (operativa, contable, regulatoria)\n• Programación de extracciones automáticas con distribución por correo/SFTP\n• Formatos de salida: Excel, CSV, JSON, XML\n• Filtros dinámicos por fecha, producto, moneda, jurisdicción y segmento",
    respuesta_en: "𝗥𝗲𝗽𝗼𝗿𝘁 𝗘𝗻𝗴𝗶𝗻𝗲 & 𝗗𝗮𝘁𝗮 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗼𝗿: SYSDE PLUS has an integrated reporting engine and data extractor that automatically generates regulatory, accounting, and management reports. The extractor allows building ad-hoc queries on any operational, accounting, or regulatory data without development involvement.\n\n𝗥𝗲𝗴𝘂𝗹𝗮𝘁𝗼𝗿𝘆 𝗥𝗲𝗽𝗼𝗿𝘁𝘀:\n• Automatic generation for superintendencies (SBS Peru, SUGEF, SIB, CNBS, SSF, CNBV)\n• Parameterizable formats per regulator (XML, CSV, Excel, PDF)\n• Portfolio classification and provisions per local regulations (including SBS Peru)\n• Risk concentration and credit exposure\n• Suspicious operations reports (ROS) and AML prevention\n• Jurisdiction-specific regulatory annexes\n\n𝗔𝗰𝗰𝗼𝘂𝗻𝘁𝗶𝗻𝗴 𝗥𝗲𝗽𝗼𝗿𝘁𝘀:\n• Automatic IFRS 16 entries with subsidiary ledger\n• Trial balance, P&L, and cash flow by product/segment\n• Automatic reconciliation between operational and accounting data\n• Depreciation, amortization, and revenue recognition per configured method\n• Multi-entity consolidated financial statements\n\n𝗠𝗮𝗻𝗮𝗴𝗲𝗺𝗲𝗻𝘁 𝗥𝗲𝗽𝗼𝗿𝘁𝘀:\n• Operational dashboards with KPIs (active portfolio, arrears, origination, profitability)\n• User-parameterizable ad-hoc report builder\n• Vintage, cohort, and portfolio behavior analysis\n• Export in Excel, PDF, CSV with automatic email distribution\n\n𝗗𝗮𝘁𝗮 𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗼𝗿:\n• Visual no-code query builder\n• Access to all data layers (operational, accounting, regulatory)\n• Scheduled automatic extractions with email/SFTP distribution\n• Output formats: Excel, CSV, JSON, XML\n• Dynamic filters by date, product, currency, jurisdiction, and segment",
