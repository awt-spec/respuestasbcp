...
export const questions: QuestionItem[] = [
  ...
  // ── Funcional (merged into A) — received 20 marzo 2026 ──
  {
    ...
    respuesta: "SYSDE PLUS está diseñado para operar a la escala de instituciones como BCP, gestionando más de 10,000 contratos de leasing simultáneos con control total y sin degradación de rendimiento.\n\n𝗖𝗮𝗽𝗮𝗰𝗶𝗱𝗮𝗱 𝗘𝗺𝗽𝗿𝗲𝘀𝗮𝗿𝗶𝗮𝗹: Arquitectura de microservicios sobre Azure con auto-scaling horizontal, diseñada para equipos grandes y operaciones robustas. La plataforma soporta volúmenes masivos — IVM (3M+ afiliados) y CMI (6 países simultáneos) — muy superiores a cualquier operación de leasing.\n\n𝗖𝗼𝗻𝘁𝗿𝗼𝗹 𝗮 𝗘𝘀𝗰𝗮𝗹𝗮: Gobernanza con segregación de funciones, cumplimiento regulatorio multi-jurisdicción (SBS), trazabilidad completa y dashboards ejecutivos en tiempo real para mantener visibilidad total sin importar el volumen de cartera.",
    respuesta_en: "SYSDE PLUS is designed to operate at the scale of institutions like BCP, managing over 10,000 simultaneous leasing contracts with total control and no performance degradation.\n\n𝗘𝗻𝘁𝗲𝗿𝗽𝗿𝗶𝘀𝗲 𝗖𝗮𝗽𝗮𝗰𝗶𝘁𝘆: Microservices architecture on Azure with horizontal auto-scaling, designed for large teams and robust operations. The platform supports massive volumes — IVM (3M+ affiliates) and CMI (6 simultaneous countries) — far exceeding any leasing operation.\n\n𝗖𝗼𝗻𝘁𝗿𝗼𝗹 𝗮𝘁 𝗦𝗰𝗮𝗹𝗲: Governance with function segregation, multi-jurisdiction regulatory compliance (SBS), complete traceability, and real-time executive dashboards to maintain total visibility regardless of portfolio volume.",
    valor: "BCP puede gestionar +10,000 contratos de leasing simultáneamente con la confianza de que SYSDE PLUS está diseñado para equipos grandes y robustos, con capacidad comprobada muy superior a lo requerido.",
    valor_en: "BCP can manage 10,000+ simultaneous leasing contracts with confidence that SYSDE PLUS is designed for large, robust teams, with proven capacity far exceeding requirements.",
  ...
  // ── Licenciamiento (D) ──
  {
    ...
    respuesta: "SYSDE PLUS opera bajo un modelo de suscripción ilimitado. Usuarios, empresas, transacciones, soporte, capacitación y desarrollo evolutivo — todo ilimitado, sin costo adicional. Una suscripción, sin sorpresas, sin cobros ocultos.",
    respuesta_en: "SYSDE PLUS operates under an unlimited subscription model. Users, companies, transactions, support, training and evolutionary development — everything unlimited, at no additional cost. One subscription, no surprises, no hidden charges.",
  ...
  // ── Datos y Reporting (I) ──
  {
    ...
    diagrams: [
      {
        type: "flow" as const,
        title: "Motor de Reportes y Extractor — SYSDE PLUS",
        steps: [
          ...
          { icon: "🔍", label: "Extractor de Datos", description: "Consultas ad-hoc sin código" },
          { icon: "📋", label: "Regulatorios", description: "SBS, SUGEF, SIB, CNBV" },
          { icon: "📊", label: "Contables + Gerenciales", description: "NIIF, dashboards, vintage" },
        ],
      },
      {
        type: "table" as const,
        title: "Tipos de Reportes, Formatos y Alcance",
        headers: ["Tipo", "Contenido", "Formatos", "Frecuencia"],
        rows: [
          ["Regulatorios", "Cartera, provisiones, riesgo, ROS, Anexos SBS", "XML, CSV, Excel, PDF", "Según regulador"],
          ["Contables", "Asientos IFRS 16, balance, P&L, consolidados", "Excel, PDF", "Diario / Mensual"],
          ["Gerenciales", "KPIs, dashboards, vintage, cosecha", "Web, Excel, PDF", "Tiempo real / Ad-hoc"],
          ["Fiscales", "Facturación electrónica, retenciones", "XML, PDF", "Por transacción"],
          ["Extractor", "Consultas ad-hoc sobre cualquier dato", "Excel, CSV, JSON, XML", "Bajo demanda / Programado"],
        ],
      },
    ],
    diagrams_en: [
      {
        type: "flow" as const,
        title: "Report Engine & Extractor — SYSDE PLUS",
        steps: [
          ...
          { icon: "🔍", label: "Data Extractor", description: "No-code ad-hoc queries" },
          { icon: "📋", label: "Regulatory", description: "SBS, SUGEF, SIB, CNBV" },
          { icon: "📊", label: "Accounting + Management", description: "IFRS, dashboards, vintage" },
        ],
      },
      {
        type: "table" as const,
        title: "Report Types, Formats and Scope",
        headers: ["Type", "Content", "Formats", "Frequency"],
        rows: [
          ["Regulatory", "Portfolio, provisions, risk, ROS, SBS Annexes", "XML, CSV, Excel, PDF", "Per regulator"],
          ["Accounting", "IFRS 16 entries, balance, P&L, consolidated", "Excel, PDF", "Daily / Monthly"],
          ["Management", "KPIs, dashboards, vintage, cohort", "Web, Excel, PDF", "Real-time / Ad-hoc"],
          ["Fiscal", "Electronic invoicing, withholdings", "XML, PDF", "Per transaction"],
          ["Extractor", "Ad-hoc queries on any data", "Excel, CSV, JSON, XML", "On-demand / Scheduled"],
        ],
      },
    ],
  },
  ...
  // ── Escalabilidad (K) ──
  {
    ...
    respuesta: "La arquitectura de SYSDE PLUS está diseñada para escalar horizontalmente mediante microservicios sobre Azure. El dimensionamiento de infraestructura se revisa anualmente para cada cliente, garantizando que la capacidad esté siempre por delante de la demanda. Referencias comprobables de volumen en producción: • IVM / RIVM — Régimen de pensiones con más de 3 millones de afiliados activos • CMI (15 países) — +54,000 colaboradores, operaciones multi-país y multi-moneda simultáneas Estos volúmenes superan ampliamente lo requerido para una operación de leasing bancario. La misma arquitectura que soporta estos clientes es la base de SYSDE PLUS Leasing.",
  ...
  // ── Nuevas consultas recibidas 26/03/2026 ──
  {
    id: 31,
    title: "Desembolsos Parciales por Tramos",
    title_en: "Partial Disbursements by Tranches",
    status: "answered",
    section: "G" as SectionKey,
    receivedDate: "26 marzo 2026",
    subtitle: "Liberación condicionada de fondos",
    subtitle_en: "Conditional fund release",
    requerimiento: "¿El sistema permite realizar desembolsos parciales?",
    requerimiento_en: "Does the system allow partial disbursements?",
    respuesta: "Sí. SAF+ permite parametrizar desembolsos por tramos, vinculando cada liberación de fondos a condiciones previamente definidas — avance de obra, entrega parcial de activos o validación documental. Cada tramo genera su propio asiento contable, actualiza el saldo vigente de la operación y queda registrado en el expediente con fecha, monto y usuario responsable.\n\n𝗖𝗮𝗿𝗮𝗰𝘁𝗲𝗿í𝘀𝘁𝗶𝗰𝗮𝘀 𝗖𝗹𝗮𝘃𝗲:\n• Cada tramo genera asiento contable independiente\n• Actualización automática del saldo vigente\n• Trazabilidad completa: fecha, monto, usuario responsable\n• Condiciones configurables por tramo: avance de obra, entrega parcial, validación documental\n• Vinculación directa al expediente de la operación",
    respuesta_en: "Yes. SAF+ allows parameterizing disbursements by tranches, linking each fund release to previously defined conditions — construction progress, partial asset delivery, or document validation. Each tranche generates its own accounting entry, updates the outstanding balance, and is recorded in the file with date, amount, and responsible user.\n\n𝗞𝗲𝘆 𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀:\n• Each tranche generates an independent accounting entry\n• Automatic outstanding balance update\n• Full traceability: date, amount, responsible user\n• Configurable conditions per tranche: construction progress, partial delivery, document validation\n• Direct linkage to the operation file",
  ...
  {
    id: 32,
    title: "Cronogramas Tailor-Made con Cuotas Variables",
    title_en: "Tailor-Made Schedules with Variable Installments",
    status: "answered",
    section: "G" as SectionKey,
    receivedDate: "26 marzo 2026",
    subtitle: "Motor de amortización flexible",
    subtitle_en: "Flexible amortization engine",
    requerimiento: "¿El sistema soporta cronogramas tailor-made con cuotas e intereses variables?",
    requerimiento_en: "Does the system support tailor-made schedules with variable installments and interest?",
    respuesta: "Sí. El motor de amortización permite ingresar cronogramas completamente irregulares, cuota a cuota, donde tanto el capital como los intereses varían período a período sin restricción de fórmula. Cubre estructuras tipo bullet, grace periods, cuotas balloon y flujos estacionales.\n\n𝗘𝘀𝘁𝗿𝘂𝗰𝘁𝘂𝗿𝗮𝘀 𝗦𝗼𝗽𝗼𝗿𝘁𝗮𝗱𝗮𝘀:\n• Cuotas fijas, variables o mixtas\n• Grace periods (solo intereses o diferimiento total)\n• Bullet payments (capital al vencimiento)\n• Balloon payments (cuota final mayor)\n• Flujos estacionales (cuotas diferenciadas por temporada)\n• Cronograma libre cuota a cuota sin fórmula",
    respuesta_en: "Yes. The amortization engine allows entering completely irregular schedules, installment by installment, where both principal and interest vary period by period without formula restrictions. It covers bullet structures, grace periods, balloon payments, and seasonal flows.\n\n𝗦𝘂𝗽𝗽𝗼𝗿𝘁𝗲𝗱 𝗦𝘁𝗿𝘂𝗰𝘁𝘂𝗿𝗲𝘀:\n• Fixed, variable, or mixed installments\n• Grace periods (interest-only or full deferral)\n• Bullet payments (principal at maturity)\n• Balloon payments (larger final installment)\n• Seasonal flows (differentiated by season)\n• Free schedule installment by installment without formula",
  ...
  {
    id: 33,
    title: "Operaciones de Leaseback (Sale & Leaseback)",
    title_en: "Leaseback Operations (Sale & Leaseback)",
    status: "answered",
    section: "G" as SectionKey,
    receivedDate: "26 marzo 2026",
    subtitle: "Gestión end-to-end de retroarrendamiento",
    subtitle_en: "End-to-end leaseback management",
    requerimiento: "¿El sistema contempla operaciones de leaseback?",
    requerimiento_en: "Does the system support leaseback operations?",
    respuesta: "Sí. SAF+ gestiona el sale & leaseback de extremo a extremo: registro de la compraventa inicial, constitución del contrato de arrendamiento financiero y seguimiento del bien durante toda su vida útil. La estructura contable mantiene el tratamiento diferenciado entre la venta y el arrendamiento.\n\n𝗙𝗹𝘂𝗷𝗼 𝗖𝗼𝗺𝗽𝗹𝗲𝘁𝗼:\n• Registro de compraventa del activo al cliente\n• Constitución automática del contrato de arrendamiento\n• Tratamiento contable diferenciado (venta vs. arrendamiento)\n• Seguimiento del bien durante toda su vida útil\n• Depreciación y valor residual gestionados automáticamente",
    respuesta_en: "Yes. SAF+ manages sale & leaseback end-to-end: initial purchase-sale registration, financial lease contract constitution, and asset tracking throughout its useful life. The accounting structure maintains differentiated treatment between sale and lease.\n\n𝗖𝗼𝗺𝗽𝗹𝗲𝘁𝗲 𝗙𝗹𝗼𝘄:\n• Asset purchase-sale registration to client\n• Automatic lease contract constitution\n• Differentiated accounting treatment (sale vs. lease)\n• Asset tracking throughout its useful life\n• Depreciation and residual value managed automatically",
  ...
  {
    id: 34,
    title: "Gastos Sobrevinientes Post-Activación",
    title_en: "Post-Activation Supervening Charges",
    status: "answered",
    section: "G" as SectionKey,
    receivedDate: "26 marzo 2026",
    subtitle: "Cargos adicionales durante vigencia",
    subtitle_en: "Additional charges during term",
    requerimiento: "¿Luego de activada la operación se pueden agregar gastos sobrevinientes?",
    requerimiento_en: "Can supervening charges be added after the operation is activated?",
    respuesta: "Sí. SAF+ permite registrar cargos sobrevinientes al activo en cualquier momento durante la vigencia de la operación — impuestos, infracciones, primas adicionales u otros gastos imputables al arrendatario. Cada cargo queda vinculado al expediente con trazabilidad completa.\n\n𝗙𝗹𝗲𝘅𝗶𝗯𝗶𝗹𝗶𝗱𝗮𝗱 𝗱𝗲 𝗚𝗲𝘀𝘁𝗶ó𝗻:\n• El operador decide si se cobra de forma independiente o se incorpora al siguiente período\n• El cronograma original no se modifica automáticamente\n• Trazabilidad completa: tipo de gasto, fecha, monto, usuario que registra\n• Generación de comprobante y notificación al arrendatario\n• Compatible con flujos de aprobación según políticas internas",
    respuesta_en: "Yes. SAF+ allows registering supervening charges to the asset at any time during the operation's term — taxes, fines, additional premiums, or other charges attributable to the lessee. Each charge is linked to the file with full traceability.\n\n𝗠𝗮𝗻𝗮𝗴𝗲𝗺𝗲𝗻𝘁 𝗙𝗹𝗲𝘅𝗶𝗯𝗶𝗹𝗶𝘁𝘆:\n• Operator decides whether to charge independently or incorporate into next period\n• Original schedule is not automatically modified\n• Full traceability: charge type, date, amount, registering user\n• Receipt generation and lessee notification\n• Compatible with approval flows per internal policies",
  ...
  {
    id: 35,
    title: "Ficha Técnica y Detalle del Activo",
    title_en: "Asset Technical Sheet and Details",
    status: "answered",
    section: "G" as SectionKey,
    receivedDate: "26 marzo 2026",
    subtitle: "Módulo de registro de activos",
    subtitle_en: "Asset registration module",
    requerimiento: "¿El sistema permite registrar los detalles del activo?",
    requerimiento_en: "Does the system allow registering asset details?",
    respuesta: "Sí. SAF+ cuenta con un módulo de ficha técnica del activo donde se registran marca, modelo, número de serie, placa, año, proveedor, valor comercial, valor residual y tabla de depreciación. La información está disponible en tiempo real dentro del expediente y es exportable para reportes regulatorios.\n\n𝗖𝗮𝗺𝗽𝗼𝘀 𝗱𝗲 𝗹𝗮 𝗙𝗶𝗰𝗵𝗮 𝗧é𝗰𝗻𝗶𝗰𝗮:\n• Marca, modelo, año de fabricación\n• Número de serie, placa, color\n• Proveedor y datos de adquisición\n• Valor comercial y valor de compra\n• Valor residual configurado\n• Tabla de depreciación (línea recta, acelerada, etc.)\n• Fotos y documentos adjuntos\n• Ubicación física del activo",
    respuesta_en: "Yes. SAF+ has an asset technical sheet module where brand, model, serial number, plate, year, supplier, market value, residual value, and depreciation table are registered. The information is available in real time within the file and is exportable for regulatory reports.\n\n𝗧𝗲𝗰𝗵𝗻𝗶𝗰𝗮𝗹 𝗦𝗵𝗲𝗲𝘁 𝗙𝗶𝗲𝗹𝗱𝘀:\n• Brand, model, manufacturing year\n• Serial number, plate, color\n• Supplier and acquisition data\n• Market value and purchase value\n• Configured residual value\n• Depreciation table (straight-line, accelerated, etc.)\n• Attached photos and documents\n• Physical asset location",
