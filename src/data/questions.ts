    ...
    diagrams: [
      {
        ...
        items: [
          ...
          "🇬🇹 Guatemala — Centroamérica norte (CMI)",
          "🇸🇻 El Salvador — Operaciones Centroamérica",
          "🇨🇴 Colombia — Región andina",
          "🇲🇽 México — Equipo local (GNP, Bankaool)",
          "🇸🇳 Senegal — África occidental",
          "🌍 Europa y Asia — Operaciones y clientes",
        ],
      },
      {
        type: "table" as const,
    ...
    diagrams_en: [
      {
        ...
        items: [
          ...
          "🇬🇹 Guatemala — Northern Central America (CMI)",
          "🇸🇻 El Salvador — Central America operations",
          "🇨🇴 Colombia — Andean region",
          "🇲🇽 Mexico — Local team (GNP, Bankaool)",
          "🇸🇳 Senegal — West Africa",
          "🌍 Europe and Asia — Operations and clients",
        ],
      },
      {
        type: "table" as const,
