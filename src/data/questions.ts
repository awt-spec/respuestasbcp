...
export const questions: QuestionItem[] = [
  ...
  // ── Funcional (merged into A) — received 20 marzo 2026 ──
  {
    ...
    respuesta: "SYSDE PLUS resuelve la fragmentación operativa y los riesgos críticos del leasing bancario mediante una plataforma unificada end-to-end.\n\n𝗥𝗶𝗲𝘀𝗴𝗼𝘀 𝗠𝗶𝘁𝗶𝗴𝗮𝗱𝗼𝘀: Fragmentación operativa, incumplimiento regulatorio, limitaciones de escalamiento, integración con sistemas legacy y control de acceso — todos resueltos con arquitectura probada en +1,000 instituciones.\n\n𝗘𝘀𝗰𝗮𝗹𝗮𝗯𝗶𝗹𝗶𝗱𝗮𝗱 𝗖𝗼𝗺𝗽𝗿𝗼𝗯𝗮𝗱𝗮: Desde piloto con ~500 contratos hasta operaciones multi-país con millones de registros (IVM: 3M+ afiliados, CMI: 6 países). Microservicios sobre Azure con auto-scaling horizontal y dimensionamiento revisado anualmente.",
    respuesta_en: "SYSDE PLUS solves operational fragmentation and critical risks in bank leasing through a unified end-to-end platform.\n\n𝗠𝗶𝘁𝗶𝗴𝗮𝘁𝗲𝗱 𝗥𝗶𝘀𝗸𝘀: Operational fragmentation, regulatory non-compliance, scaling limitations, legacy system integration, and access control — all solved with architecture proven in 1,000+ institutions.\n\n𝗣𝗿𝗼𝘃𝗲𝗻 𝗦𝗰𝗮𝗹𝗮𝗯𝗶𝗹𝗶𝘁𝘆: From pilot with ~500 contracts to multi-country operations with millions of records (IVM: 3M+ affiliates, CMI: 6 countries). Microservices on Azure with horizontal auto-scaling and annually reviewed dimensioning.",
    valor: "SYSDE PLUS mitiga los riesgos operativos y de escalabilidad más críticos del leasing bancario, con arquitectura probada desde piloto hasta operaciones masivas multi-país.",
