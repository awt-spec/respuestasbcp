...
export const questions: QuestionItem[] = [
  ...
  // ── Funcional (merged into A) — received 20 marzo 2026 ──
  {
    ...
    respuesta: "SYSDE PLUS permite a instituciones del tamaño de BCP incorporar y escalar su operación de leasing con control total, integrada a su ecosistema tecnológico existente.\n\n𝗥𝗶𝗲𝘀𝗴𝗼𝘀 𝗠𝗶𝘁𝗶𝗴𝗮𝗱𝗼𝘀: Desacoplamiento del leasing respecto al core bancario, cumplimiento regulatorio multi-jurisdicción (SBS), gobernanza y segregación de funciones, y crecimiento de cartera sin perder visibilidad — todos resueltos con arquitectura probada en +1,000 instituciones.\n\n𝗘𝘀𝗰𝗮𝗹𝗮𝗯𝗶𝗹𝗶𝗱𝗮𝗱: La misma plataforma soporta IVM (3M+ afiliados) y CMI (6 países con SAP). La capacidad supera ampliamente lo requerido para leasing bancario. Auto-scaling sobre Azure con dimensionamiento revisado anualmente.",
